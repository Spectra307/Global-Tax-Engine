 ...
 */
const { getRuleByCountry, getAllRules } = require('./datasetLoader');

/**
 * Calculates tax for a cross-border sale.
 */
async function calculateTax(amount, destCountry, sourceCountry, productType, buyerType, destState = null) {
  // --- Input Validation ---
 ...
 */
async function calculateWhatIf(amount, productType, buyerType) {
